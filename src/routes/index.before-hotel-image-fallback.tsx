...
export const Route = createFileRoute("/index/before-hotel-image-fallback")({
  head: () => ({
    meta: [
      ...
      <div className="mt-6 flex flex-wrap items-center justify-center gap-2 text-xs text-muted-foreground">
        ...
        {engine.providerInfo.provider && (
          <Badge>
            ...
            {engine.providerInfo.speaker ? ` ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· ${engine.providerInfo.speaker}` : ""}
          </Badge>
        )}
      </div>
